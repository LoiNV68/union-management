<div class="flex items-start max-md:flex-col">
    <div class="me-10 w-full pb-4 md:w-[220px]">
        <flux:navlist>
            ...
            <flux:navlist.item :href="route('user-password.edit')" wire:navigate>{{ __('Mật khẩu') }}
            </flux:navlist.item>
            @if (Laravel\Fortify\Features::canManageTwoFactorAuthentication())
                <flux:navlist.item :href="route('two-factor.show')" wire:navigate>{{ __('Xác thực hai yếu tố') }}
                </flux:navlist.item>
            @endif
