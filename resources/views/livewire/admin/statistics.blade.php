<section>
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <!-- Revenue Card -->
            <div class="premium-card stat-card p-6 group relative overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="absolute top-0 right-0 w-32 h-32 bg-green-200 dark:bg-green-900/20 rounded-full -mr-16 -mt-16 opacity-20"></div>
                <div class="relative">
                    ...
                    <p class="text-3xl font-bold text-green-600 mb-2">
                        {{ number_format($this->summaryStatistics['actual_revenue'], 0, ',', '.') }}<span class="text-lg">₫</span>
                    </p>
            ...
            <!-- Expense Card -->
            <div class="premium-card stat-card p-6 group relative overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="absolute top-0 right-0 w-32 h-32 bg-red-200 dark:bg-red-900/20 rounded-full -mr-16 -mt-16 opacity-20"></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <p class="text-3xl font-bold text-red-600 mb-2">
                        {{ number_format($this->summaryStatistics['total_expense'], 0, ',', '.') }}<span class="text-lg">₫</span>
                    </p>
                </div>
            </div>
            ...
            <!-- Net Profit Card -->
            <div class="premium-card stat-card p-6 group relative overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="absolute top-0 right-0 w-32 h-32 bg-blue-200 dark:bg-blue-900/20 rounded-full -mr-16 -mt-16 opacity-20"></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <p class="text-3xl font-bold {{ $this->summaryStatistics['net_profit'] >= 0 ? 'text-green-600' : 'text-red-600' }} mb-2">
                        {{ number_format($this->summaryStatistics['net_profit'], 0, ',', '.') }}<span class="text-lg">₫</span>
                    </p>
                    <div class="flex items-center gap-2 text-xs">
                        <span class="px-2 py-1 rounded-full {{ $this->summaryStatistics['net_profit'] >= 0 ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' }}">
            ...
            <!-- Payment Rate Card -->
            <div class="premium-card stat-card p-6 group relative overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="absolute top-0 right-0 w-32 h-32 bg-purple-200 dark:bg-purple-900/20 rounded-full -mr-16 -mt-16 opacity-20"></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2 text-xs text-neutral-500">
                        ...
                        <span>{{ $this->summaryStatistics['paid_transactions'] }}/{{ $this->summaryStatistics['total_member_transactions'] }} đã thanh toán</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b-2 border-neutral-200 dark:border-neutral-700">
                            <th class="text-left py-4 px-4 font-semibold text-neutral-900 dark:text-neutral-100">Chi đoàn</th>
                            <th class="text-right py-4 px-4 font-semibold text-neutral-900 dark:text-neutral-100">Thành viên</th>
                            <th class="text-right py-4 px-4 font-semibold text-neutral-900 dark:text-neutral-100">Tổng thu</th>
                            <th class="text-right py-4 px-4 font-semibold text-neutral-900 dark:text-neutral-100">Thanh toán</th>
                            <th class="text-right py-4 px-4 font-semibold text-neutral-900 dark:text-neutral-100">Tỷ lệ</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                        @forelse($this->branchStatistics as $stat)
                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-150">
                                <td class="py-4 px-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center text-white font-bold">
                                ...
                                <td class="py-4 px-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <div class="w-20 bg-neutral-200 dark:bg-neutral-700 rounded-full h-2 overflow-hidden">
